...
public class ControlSesion extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//Inicializo el objeto con el request.getSession para abrir una "puerta" llamada sesion 
		sesion = request.getSession();
		
		//Variable para almacenar el dato que queremos guardar en la sesion, debería entrar de un request.getParameter
		String nombreUsuario = "Daniel";
		
		//Le decimos a sesion con el método setAttribute que nos GUARDE con la clave que queramos el valor que le doy, en este caso el id.
	...
	/*
	 * Esta parte sería la que metería en el resto de servlets que necesiten el dato de sesion (en el doGet)
	 * La sesión caduca, hay que mirar la duración en la configuración de apache pero suelen ser 30 minutos.
	 * 
	...
	/*
	 * Para cerrar la sesión meteremos el siguiente código. Este código elimina cualquier dato que esté en la sesión.
	 * 
